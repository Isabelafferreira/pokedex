  ...
  return (
    <div data-fs-home-container>
      ...
      <div data-fs-search-container>
        ...
        />
        <button data-fs-button onClick={searchPokemon} id="search">
          Search
        </button>
      </div>

      {showModal && <Modal pokemonData={pokemonData} closeModal={closeModal} />}

      {errorMessage && <p data-fs-error-message>{errorMessage}</p>}
    </div>
  );
}
